...
The current build status on the CI server is <a href="http://build.gertjvr.com/viewType.html?buildTypeId=TeamBot_01BuildAndTest&guest=1">
<img src="http://build.gertjvr.com/app/rest/builds/buildType:(id:TeamBot_01BuildAndTest)/statusIcon"/></a>
